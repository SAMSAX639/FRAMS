                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Everyday </h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>Sno.</th>
				...
				<th>Subject</th>
					...
					$ret=mysqli_query($con,"SHOW COLUMNS FROM Students");
							...
							$cnt=1; $sno=0; 
							  ...
							  {
					$lec=$row['Field']; $arr=(explode("_",$lec));  
								
						if($cnt>6 && !in_array($arr[4],$times)){
								 ?>
                              <tr> 
                              <td><?php echo $sno-5;  ?></td>
					
	<td><?php echo $arr[4] . ' - ' . $arr[5];  array_push($times,$arr[4]); ?></td>					
					<?php $ret1=mysqli_query($con,"SELECT subject FROM timetable WHERE time=$arr[4]");
