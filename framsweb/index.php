...
if(isset($_POST['login']))
{
  ...
  $pass=$_POST['password'];
$ret=mysqli_query($con,"SELECT * FROM Students WHERE PRN='$adminusername' and Password='$pass'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
$extra="attendance.php";
...
<html lang="en">
  <head>
    ...
    <title>FRAMS | Student Login</title>
	  	...
	  	<div class="container">
		      ...
		      <form class="form-login" action="" method="post">
		        ...
		        <div class="login-wrap">
		         ...
		         <input  name="admin" class="btn btn-theme btn-block" type="submit" value="Admin Login" />
		        </div>
		      </form>	  	
